...
import { Mail, Linkedin, Github, Bot, Sparkles, Briefcase, Rocket, BrainCircuit, Store, CalendarCheck, ChefHat, MessageSquareHeart } from 'lucide-react';
import { CVData, Project, Experience } from './types';
    ...
    return (
        <div className="bg-background text-foreground transition-colors duration-300 relative z-0">
          ...
          />
                    ...
                    <Certifications ref={sectionRefs.certifications} certifications={cvData.certifications} languages={cvData.languages} />
